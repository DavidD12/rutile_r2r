...
async fn srv_0(request: AddTwoInts::Request) -> AddTwoInts::Response {
    println!("future_mono service arity 0: {} {}", request.a, request.b);
    AddTwoInts::Response {
...
async fn srv_2(a: i64, b: i64, request: AddTwoInts::Request) -> AddTwoInts::Response {
    println!("future_mono service arity 2: {} {}", a, b);
    AddTwoInts::Response {
...
async fn srv_5(
    ...
    println!("future_mono service arity 5: {} {} {} {} {}", a, b, c, d, e);
    AddTwoInts::Response {
...
fn main() -> Result<()> {
    let mut node = Node::create("macro_service_future_mono", "")?;
