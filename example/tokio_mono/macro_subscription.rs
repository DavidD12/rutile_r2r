...
async fn sub_0(message: r2r::std_msgs::msg::String) {
    println!("tokio_mono subscription arity 0: {:?}", message.data);
}

async fn sub_2(a: i32, b: i32, message: r2r::std_msgs::msg::String) {
    println!(
        "tokio_mono subscription arity 2: {} {} {:?}",
        a, b, message.data
    );
}
...
async fn sub_5(a: i32, b: i32, c: i32, d: i32, e: i32, message: r2r::std_msgs::msg::String) {
    println!(
        "tokio_mono subscription arity 5: {} {} {} {} {} {:?}",
        a, b, c, d, e, message.data
    );
}

fn main() -> Result<()> {
    let mut node = Node::create("macro_subscription_tokio_mono", "")?;
