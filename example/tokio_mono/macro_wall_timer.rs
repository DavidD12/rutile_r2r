...
async fn timer_0() {
    println!("tokio_mono wall timer arity 0");
}

async fn timer_2(a: i32, b: i32) {
    println!("tokio_mono wall timer arity 2: {} {}", a, b);
}

async fn timer_5(a: i32, b: i32, c: i32, d: i32, e: i32) {
    println!("tokio_mono wall timer arity 5: {} {} {} {} {}", a, b, c, d, e);
}

fn main() -> Result<()> {
    let mut node = Node::create("macro_wall_timer_tokio_mono", "")?;
